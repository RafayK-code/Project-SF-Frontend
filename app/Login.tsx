    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.signInCont}>
                ...
                <Text style={styles.description}>University is hard, studying is hard, use "name here" to make finding study groups easier and fun!</Text>

                <View style={{ height: "25%" }}></View>

                <ActionButton text="Sign In" onClick={() => { }}></ActionButton>

                <ClickableText text="Forgot Password?" onClick={() => { }}></ClickableText>
